...
def build_reid_train_loader(cfg, mapper=None, **kwargs):
    ...
    if cfg.INPUT.DO_RESIZEAUG:
        train_set = CommDataset(train_items, transforms, relabel=True, random_resize_twice=True)
    else:
        train_set = CommDataset(train_items, transforms, relabel=True, random_resize_twice=False)
...
def build_reid_test_loader(cfg, dataset_name, mapper=None, **kwargs):
    ...
    test_set = CommDataset(test_items, transforms, relabel=False, random_resize_twice=False)

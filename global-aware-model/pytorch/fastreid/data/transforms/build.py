...
def build_transforms(cfg, is_train=True):
    ...
    if is_train:
        ...
        if do_crop:
            res.append(T.Resize([size_train[0]+16, size_train[0]+16], interpolation=3))
            res.append(T.RandomCrop(size_train))
        else:
            res.append(T.Resize(size_train, interpolation=3))
        ...
        #res.append(T.Resize([70,110], interpolation=3))

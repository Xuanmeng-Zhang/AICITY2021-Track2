...
def parse_args():
    ...
    add_arg('pretrain',         str,    'pretrained/HRNet_W48_C_ssld_pretrained', "The pretrain model path.")
    add_arg('weights',          str,    'model_final', "The weights path.")

    add_arg('data_dir',         str,    'dataset/aicity21_all',      "The data root path.")
    add_arg('test_data_dir',    str,    'dataset/aicity21_all',      "The data root path.")
    ...
    add_arg('warm_up_iter',     float,  5000,  "Learning rate.")
    add_arg('start_iter',       int,    0,      "Start iteration.")
    add_arg('max_iter',         int,    45000, "Iter number.")    
    add_arg('snapshot_iter',    int,    1000,   "Save model every snapshot stride.")
    parser.add_argument('--lr_steps', nargs='+', type=int, default=[25000, 35000, 45000], help="The mean of input image data")
    ...
    add_arg('big_height',       int,    400,    "Image big_height.")
    add_arg('big_width',        int,    400,    "Image big_width.")

...
def ResNeXt101_32x8d_wsl_att():
    model = ResNeXt101_wsl_att(cardinality=32, width=8)
    return model


def ResNeXt101_32x16d_wsl_att():
    model = ResNeXt101_wsl_att(cardinality=32, width=16)
    return model
